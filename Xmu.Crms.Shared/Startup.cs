    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            foreach (var assembly in _startupConfig.ControllerAssemblies)
            {
                ...
                if (TryPath(_hostingEnvironment.ContentRootPath + "\\wwwroot") != null)
                {
                    _startupConfig.WebRootPath.Add(Path.GetFullPath(_hostingEnvironment.ContentRootPath + "\\wwwroot"));
                }
            }
